<script>
	 ...
	 * @property {'text' | 'card' | 'chart' | 'circle'} [variant] - Skeleton variant
	 */

	/** @type {Props} */
	let { class: className = '', variant = 'text' } = $props();
</script>

{#if variant === 'text'}
	<div class="bg-warm-grey animate-pulse h-4 rounded w-full {className}"></div>
