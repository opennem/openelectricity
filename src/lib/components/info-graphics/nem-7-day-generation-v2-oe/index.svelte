<script>
	/**
	 * NEM 7-Day Generation Chart v2 — OE API variant
	 *
	 * Identical to nem-7-day-generation-v2, but fed by /api/tracker/7d-oe
	 * (OE API) instead of the static OpenNEM JSON. Kept as a separate component
	 * so both can render side by side for data comparison; shares the legend
	 * helper with the original.
	 */
	...
	import legend from '../nem-7-day-generation-v2/helpers/legend';
	...
	const chart = new ChartStore({
		key: Symbol('nem-7-day-generation-v2-oe'),
		title: 'NEM 7-Day Generation (OE)',
		prefix: 'G',
		displayPrefix: 'G',
		baseUnit: 'W',
