<script>
	...
	const { selectedDataLabel } = getContext('model');
	const { seriesItems } = getContext('projection-explorer');

	export let combinedSeriesLabels;
	export let combinedSeriesColours;
	export let hoverData;

	function handleSort(e) {
		$seriesItems = e.detail.items;
	}
</script>
