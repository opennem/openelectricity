...
export async function POST({ request }) {
	...
	const doc = await client.create({
		...
		annotationCsvText: body.annotationCsvText ?? '',
		annotationMappings: JSON.stringify(body.annotationMappings ?? {}),
		annotationStyle: JSON.stringify(body.annotationStyle ?? {}),
		annotationRowOptions: JSON.stringify(body.annotationRowOptions ?? {}),
