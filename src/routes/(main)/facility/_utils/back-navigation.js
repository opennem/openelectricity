...
/**
 * Navigate back from a facility detail page, falling back to the facilities
 * page with this facility's pane open (`?facility=` is read by /facilities to
 * preselect the detail panel).
