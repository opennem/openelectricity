/**
 * Storage utilities for Stratify Plot chart persistence.
 * localStorage for the builder, plus JSON file export/import.
 */
 ...
 *
 * @typedef {import('../_state/StratifyPlotProject.svelte.js').StratifyPlotSnapshot & { id: string, createdAt: string, updatedAt: string }} SavedChart
 */

const LOCAL_PREFIX = 'stratify-plot:chart:';
const LOCAL_INDEX_KEY = 'stratify-plot:index';
 ...
 * @returns {Promise<import('../_state/StratifyPlotProject.svelte.js').StratifyPlotSnapshot | null>}
 */
